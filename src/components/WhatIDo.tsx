        ...
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                ...
                FastAPI, JWT authentication, WebSockets, RBAC, and OAuth 2.0. Experienced
                in containerizing services with Docker and deploying on AWS EC2.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                Building production-quality Android applications using Kotlin and
                Jetpack Compose with MVVM architecture. Integrating Firebase Auth,
                Firestore, FCM, and hardware sensor APIs for real-time mobile experiences.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
                ...
                <div className="what-tags">FCM</div>
